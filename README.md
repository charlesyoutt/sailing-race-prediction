...
The goal is to understand how sailor experience, team context, venue history, and race structure influence finishing positions, and to use those signals to train an interpretable machine learning model.
